    ...
    <main className="min-h-screen flex flex-col md:flex-row">
      <section className="hidden md:flex md:w-1/2 lg:w-3/5 relative overflow-hidden bg-primary-container">
        ...
        <div className="relative z-20 flex flex-col justify-end p-margin-edge w-full">
          <h1 className="font-display-lg text-display-lg text-white mb-unit-sm">Join the Heritage.</h1>
          <p className="font-body-lg text-body-lg text-white/90 max-w-md">Become a part of the Rohmani community and enjoy exclusive access to our handcrafted collections.</p>
        </div>
      </section>
      ...
      <section className="w-full md:w-1/2 lg:w-2/5 flex flex-col justify-center items-center bg-surface px-unit-lg py-section-gap">
        <div className="w-full max-w-md space-y-unit-lg">
          ...
          <div className="space-y-unit-xs text-center md:text-left">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant">Sign up to start your journey with us.</p>
          </div>
          ...
          {message && (
            <div className="p-4 bg-primary/10 text-primary text-sm font-body-md border border-primary/20">
              {message}
            </div>
          )}
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div className="space-y-unit-xs">
                <label className="block font-label-caps text-label-caps uppercase text-on-surface-variant" htmlFor="confirmPassword">Confirm Password</label>
                <input 
                  className="w-full px-0 py-3 bg-transparent border-b border-outline-variant focus:border-primary focus:ring-0 transition-colors font-body-md text-on-surface placeholder:text-outline-variant" 
                  id="confirmPassword" 
          ...
          <div className="pt-8 text-center">
            <p className="font-body-md text-body-md text-on-surface-variant">
              ...
              <Link className="text-primary font-semibold hover:underline transition-all ml-1" to="/login">Login</Link>
            </p>
          </div>
        </div>
      </section>
