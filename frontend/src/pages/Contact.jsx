          ...
          <div className="space-y-12">
            ...
            <div className="pt-8 border-t border-stone-100">
              ...
              <div className="flex gap-6">
                ...
                <a href="https://wa.me/c/923218669885" target="_blank" rel="noopener noreferrer" className="text-stone-600 hover:text-primary transition-colors flex items-center gap-2">
                  ...
                  <span className="uppercase font-label-caps text-xs">WhatsApp</span>
                </a>
              </div>
            </div>
          </div>
